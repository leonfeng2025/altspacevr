...
export default class HelloWorld {
	...
	private started() {
		...
		let local_asset = this.assets
		let local_generateSpinKeyframes = this.generateSpinKeyframes(20, MRE.Vector3.Up())
		...
		this.cube.onGrab('begin',function(){
			...
			const spinAnimData = local_asset.createAnimationData(
				...
				"Spin",
				{
					...
					tracks: [{  // tracks : 轨迹
						...
						// 旋转时间将设定为20秒
						keyframes: local_generateSpinKeyframes,
